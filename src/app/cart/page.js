                            ...
                            <div className="axil-product-cart-wrap">
                                ...
                                <div className="row">
                                    <div className="col-xl-5 col-lg-7 offset-xl-7 offset-lg-5">
                                        <div className="axil-order-summary mt--80">
                                            <h5 className="title mb--20">Order Summary</h5>
                                            <div className="summary-table-wrap">
                                                <table className="table summary-table mb--30">
                                                    <tbody>
                                                        ...
                                                        <tr className="order-shipping">
                                                            ...
                                                            <td>
                                                                ...
                                                                <div className="input-group">
                                                                    ...
                                                                    <label htmlFor="radio2">Local: {convertPrice(35)} {currency}</label>
                                                                </div>
                                                                <div className="input-group">
                                                                    <input type="radio" id="radio3" name="shipping" />
                                                                    <label htmlFor="radio3">Flat rate: {convertPrice(12)} {currency}</label>
                                                                </div>
                                                            </td>
                                                        </tr>
